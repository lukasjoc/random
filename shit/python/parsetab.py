...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','calc.py',47),
  ('expr -> expr MINUS expr','expr',3,'p_sub','calc.py',51),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','calc.py',55),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','calc.py',59),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','calc.py',60),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','calc.py',71),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','calc.py',75),
]
